                    ...
                    <div className="container">
                        <div className="row g-xl-7 g-4 mb-xxl-7 mb-6 justify-content-center">
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6" data-aos="zoom-in-right" data-aos-duration={2000}>
                                <div className="contact-sub-info bg1-clr text-center">
                                    <svg width={54} height={54} viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M27 13.1111V27H40.8889M27 52C13.1929 52 2 40.8072 2 27C2 13.1929 13.1929 2 27 2C40.8072 2 52 13.1929 52 27C52 40.8072 40.8072 52 27 52Z" stroke="#AEC435" strokeWidth={4} strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                    <h5 className="white mt-xxl-7 mt-6 mb-xxl-7 mb-6">
                                        Office Hour
                                    </h5>
                        ...
                        {/* Updated Contact Form Section with Map and Modern Form */}
